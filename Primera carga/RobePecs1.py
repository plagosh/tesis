...
#while (j!=3000):
    ...
    if response.status_code==200:
        ...
        while (i!=1):
            ...
            url_imgae='https://api.arasaac.org/api/pictograms/'+str(imga)+'?plural=false&color=true&resolution=500&url=true&download=true'
            #print(url_imgae)
