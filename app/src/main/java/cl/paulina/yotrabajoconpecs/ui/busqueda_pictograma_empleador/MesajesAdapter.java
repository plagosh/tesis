...
public class MesajesAdapter extends RecyclerView.Adapter<MesajesAdapter.MensajesViewHolder> {
    private List<MensajeDeTexto> mensajedetexto;
    private Context context;
    public MesajesAdapter(List<MensajeDeTexto> mensajedetexto, Context context) {
